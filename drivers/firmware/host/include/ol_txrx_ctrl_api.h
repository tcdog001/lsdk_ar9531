...
/**
 * @brief set the Tx encapsulation type of this VDEV
 * @details
...
/**
 * @brief get the Tx encapsulation type of this VDEV
 *
 * @param vdev - the data virtual device object
 ...
 */
void
ol_txrx_set_rx_decap_mode(
    ol_txrx_pdev_handle pdev,
    enum htt_pkt_type val);

/**
 * @brief get the Rx decapsulation mode of the PDEV
 *
 * @param pdev - the physical device object
 * @return - the Rx decap mode
 */
enum htt_pkt_type
