...
ar9300_ppm_get_rssi_dump(struct ath_hal *ah)
{
	...
	reg = (AR_SREV_DRAGONFLY(ah)) ? AR_PHY_CHAN_INFO_GAIN_0_DRAGONFLY:AR_PHY_CHAN_INFO_GAIN_0;
...
ar9300_ppm_force(struct ath_hal *ah)
{
	...
	reg = (AR_SREV_DRAGONFLY(ah)) ? AR_PHY_CHNINFO_GAINDIFF_DRAGONFLY:AR_PHY_CHNINFO_GAINDIFF;
...
ar9300_ppm_arm_trigger(struct ath_hal *ah)
{
	...
	reg = (AR_SREV_DRAGONFLY(ah)) ? AR_PHY_CHAN_INFO_MEMORY_DRAGONFLY:AR_PHY_CHAN_INFO_MEMORY;
...
#undef REG_READ
	...
	if (AR_SREV_HONEYBEE_11_OR_LATER(ah)) {
