...
#define IEEE80211_MEASREQ_CHLOAD_TOKEN          2
#define IEEE80211_MEASREQ_STASTATS_TOKEN        3
#define IEEE80211_MEASREQ_NHIST_TOKEN           4
#define IEEE80211_MEASREQ_TSMREQ_TOKEN          5
#define IEEE80211_MEASREQ_FRAME_TOKEN           6
#define IEEE80211_MEASREQ_LCI_TOKEN             7
...
struct ieee80211_nr_ie {
    ...
    u_int8_t    bsinfo1_reserved:6; /* BSINFO Byte1 reserved B2-7 */
...
u_int8_t *ieee80211_add_measreq_tsm_ie(u_int8_t *frm, 
                       ieee80211_rrm_tsmreq_info_t *tsm_info);
